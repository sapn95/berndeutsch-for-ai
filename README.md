...
flowchart TD
    ...
    B -->|yes| FULL["inject the FULL rulebook<br/>about 10 KB, once per session"]
    B -->|no| CL["inject the short checklist<br/>about 2.5 KB"]
...
collision costs 2.4 KB rather than 10 KB and the next genuinely Bernese prompt
